...
from schemas import ArchiveObjectParams, CreateObjectParams, GetObjectParams, ListObjectsParams, UpdateObjectParams
...
@chat.function(name="list_contacts", description="List contact records.")
async def list_contacts(ctx, params: ListObjectsParams) -> ActionResult:
    return await list_objects(ctx, _pin(params, "contacts"))


@chat.function(name="get_contact", description="Read one contact in full. Set id_property='email' to look up by email instead of internal id.")
async def get_contact(ctx, params: GetObjectParams) -> ActionResult:
    return await get_object(ctx, _pin(params, "contacts"))


@chat.function(name="create_contact", description="Create a new contact record.", action_type="write")
async def create_contact(ctx, params: CreateObjectParams) -> ActionResult:
    return await create_object(ctx, _pin(params, "contacts"))


@chat.function(name="update_contact", description="Update an existing contact's properties.", action_type="write")
async def update_contact(ctx, params: UpdateObjectParams) -> ActionResult:
    return await update_object(ctx, _pin(params, "contacts"))


@chat.function(name="archive_contact", description="Archive (soft-delete) a contact.", action_type="write")
...
@chat.function(name="list_deals", description="List deal records.")
async def list_deals(ctx, params: ListObjectsParams) -> ActionResult:
    return await list_objects(ctx, _pin(params, "deals"))


@chat.function(name="get_deal", description="Read one deal in full -- stage, amount, close date, pipeline.")
async def get_deal(ctx, params: GetObjectParams) -> ActionResult:
    return await get_object(ctx, _pin(params, "deals"))


@chat.function(name="create_deal", description="Create a new deal record.", action_type="write")
async def create_deal(ctx, params: CreateObjectParams) -> ActionResult:
    return await create_object(ctx, _pin(params, "deals"))


@chat.function(name="update_deal", description="Update an existing deal's properties (e.g. move it to a new stage).", action_type="write")
async def update_deal(ctx, params: UpdateObjectParams) -> ActionResult:
    return await update_object(ctx, _pin(params, "deals"))


@chat.function(name="archive_deal", description="Archive (soft-delete) a deal.", action_type="write")
...
@chat.function(name="list_tickets", description="List support ticket records.")
async def list_tickets(ctx, params: ListObjectsParams) -> ActionResult:
    return await list_objects(ctx, _pin(params, "tickets"))


@chat.function(name="get_ticket", description="Read one support ticket in full.")
async def get_ticket(ctx, params: GetObjectParams) -> ActionResult:
    return await get_object(ctx, _pin(params, "tickets"))


@chat.function(name="create_ticket", description="Create a new support ticket.", action_type="write")
async def create_ticket(ctx, params: CreateObjectParams) -> ActionResult:
    return await create_object(ctx, _pin(params, "tickets"))


@chat.function(name="update_ticket", description="Update an existing ticket's properties (e.g. status, priority).", action_type="write")
async def update_ticket(ctx, params: UpdateObjectParams) -> ActionResult:
    return await update_object(ctx, _pin(params, "tickets"))


@chat.function(name="archive_ticket", description="Archive (soft-delete) a support ticket.", action_type="write")
...
@chat.function(name="list_products", description="List product catalog records.")
async def list_products(ctx, params: ListObjectsParams) -> ActionResult:
    return await list_objects(ctx, _pin(params, "products"))


@chat.function(name="get_product", description="Read one product catalog record in full.")
async def get_product(ctx, params: GetObjectParams) -> ActionResult:
    return await get_object(ctx, _pin(params, "products"))


@chat.function(name="create_product", description="Create a new product catalog record.", action_type="write")
async def create_product(ctx, params: CreateObjectParams) -> ActionResult:
    return await create_object(ctx, _pin(params, "products"))


@chat.function(name="update_product", description="Update an existing product's properties (name, price, description).", action_type="write")
async def update_product(ctx, params: UpdateObjectParams) -> ActionResult:
    return await update_object(ctx, _pin(params, "products"))


@chat.function(name="archive_product", description="Archive (soft-delete) a product catalog record.", action_type="write")
...
@chat.function(name="list_line_items", description="List line-item records (individual products attached to a deal).")
async def list_line_items(ctx, params: ListObjectsParams) -> ActionResult:
    return await list_objects(ctx, _pin(params, "line_items"))


@chat.function(name="get_line_item", description="Read one line item in full.")
async def get_line_item(ctx, params: GetObjectParams) -> ActionResult:
    return await get_object(ctx, _pin(params, "line_items"))


@chat.function(name="create_line_item", description="Create a new line item (attach it to a deal afterwards via associate_objects).", action_type="write")
...
@chat.function(name="update_line_item", description="Update an existing line item's properties (quantity, price).", action_type="write")
...
@chat.function(name="archive_line_item", description="Archive (soft-delete) a line item.", action_type="write")
